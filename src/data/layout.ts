...
export const ABOUT = {
  ...
  achievements: [
    ...
    "Contributed to clear and concise API and UI documentation",
    ...
    "Interacted with relational (PostgreSQL) and non-relational databases (MongoDB, Redis, Firebase) through ORMs like Prisma and Mongoose for efficient data management.",

...
export const PROJECTS = [
  {
    ...
    icon: {
      src: "https://res.cloudinary.com/myproyects/image/upload/h_70,w_70,q_100/v1653423487/proyects/pinterest_clone_cnv9gm.webp",
  ...
  },
  {
    ...
    icon: {
      src: "https://res.cloudinary.com/myproyects/image/upload/h_70,w_70,q_100/v1649722451/proyects/logo_1_h6lncq.webp",
  ...
  },
  {
    ...
    color: "#fff",
    icon: {
      src: "https://res.cloudinary.com/myproyects/image/upload/h_70,w_70,q_100/v1647889209/proyects/Component_10_1_dwj9o4.webp",
      alt: "Tecno Rev logo",
    },
    captions: [
      {
  ...
  },
  {
    ...
    icon: {
      src: "https://res.cloudinary.com/myproyects/image/upload/h_70,w_70,q_100/v1645665799/proyects/ortex_1_ishhld.webp",
      alt: "portfolio logo",
    },
    captions: [
      {
  ...
  },
  {
    ...
    icon: {
      src: "https://res.cloudinary.com/myproyects/image/upload/h_70,w_70,q_100/v1642998067/proyects/target_2_aqjj3g.webp",
  ...
  },
  {
    ...
    icon: {
      src: "https://res.cloudinary.com/myproyects/image/upload/h_70,w_70,q_100/v1642998067/proyects/target_r60diw.webp",
  ...
  },
  {
    ...
    icon: {
      src: "https://res.cloudinary.com/myproyects/image/upload/h_70,w_70,q_100/v1643991147/burger_rgepyv.webp",
      alt: "delivery app logo",
    },
    captions: [
      {
    ...
    summary:
      "App created to help restaurants with the advertising and management of their menu, along with real-time monitoring and actualization of their order's status.",
    language: "javascript",
    features: [
      ...
      "Add, select quantity and remove products from the cart.",
      "Editable profile.",
      "History of orders and their status.",
      "Order cancelation option available  before it's been accepted for the admin.",
      "Add new products, edit, delete or hide them.",
      "Add, rename and eliminate categories along with the products that belong to them.",
  ...
  },
  {
    ...
    color: "#34393f",
    icon: {
      src: "https://res.cloudinary.com/myproyects/image/upload/h_70,w_70,q_100/v1642998071/proyects/target_3_jhisbz.webp",
    ...
    summary:
      "Modern and interactive web portfolio made for photographic services.",
    language: "javascript",
    technologies: {
...
export const SKILLS = [
  ...
  "Experience applying SEO and performance optimizations as well as following accessibility standards.",
